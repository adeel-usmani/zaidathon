        ...
        <div className="max-w-[1440px] max-h-[499px] mx-auto pt-20 pb-0 flex flex-col lg:flex-row justify-between items-start lg:h-[499px]  lg:space-y-0">
          <div className="flex flex-col gap-4 justify-start items-start ">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
              <div className="h-[35px] w-[35px] rounded-full bg-black text-white flex justify-center items-center cursor-pointer invert hover:invert-0 transition-all duration-300">
